...
class ManagerContiformScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            wo_tasks:'',
    ...
    _handleSearchWoTaskModal = () => {
        this.setState({areaEndpoint:area.contiform})
...
export default connect(mapStateToProps,mapDispatchToProps)(ManagerContiformScreen)
