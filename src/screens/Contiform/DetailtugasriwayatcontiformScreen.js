                    ...
                    {loading ? (
                        ...
                        <View>
                            ...
                            <View style={{marginTop:13,marginBottom:13,paddingHorizontal:19,paddingVertical:12,backgroundColor:colors.putih}}>
                                ...
                                <FlatList
                                    data={detail_wo}
                                    renderItem={managers.includes(this.props.userDetail.res.Jabatan) ? this._renderItemTugasCheckbox : (wo_tasks.Status == 1) ? this._renderItemTugas : this._renderItemTugasCheckbox}
                                    keyExtractor={(item,id)=>id.toString()}
                                />
                            </View>
                            {/* END OF TUGAS */}
